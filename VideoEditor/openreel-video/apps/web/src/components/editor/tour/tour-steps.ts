...
export const TOUR_STEPS: TourStep[] = [
  {
    id: "welcome",
    target: null,
    title: "Welcome to SenseScrub",
    description:
      "A quick map of the editor layout: tools on the left, playback in the center, timeline below, and properties on the right.",
    position: "center",
  },
  {
    id: "assets",
...
export const ONBOARDING_KEY = "sensescrub-onboarding-complete";
